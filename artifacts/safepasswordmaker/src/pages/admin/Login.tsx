    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Restricted access — administrators only</p>
        </div>
        ...
        <div className="text-center mt-6 text-sm text-muted-foreground space-y-2">
          <p>Contributor? <Link href="/auth/login" className="text-primary hover:underline">Contributor login</Link></p>
          <p>New here? <Link href="/auth/register" className="text-primary hover:underline">Create account</Link></p>
